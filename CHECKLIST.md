...
- [x] 양손으로 연어를 잡은 준비 프레임
- [x] 양손과 연어를 입까지 들어 올린 식사 프레임
- [x] 연어를 직접 베어 무는 식사 표현
- [x] 3.2초 2프레임 무한 반복
- [x] 모션 최소화 접근성 대응
- [x] 모바일 들기·먹기 프레임 검증


## PHASE 14 — 곰 캐릭터 마우스 모션

- [x] 마우스 위치 기반 좌우·상하 이동
- [x] 마우스 방향 기반 기울기
- [x] 히어로 이탈 시 원위치 복귀
- [x] 터치 입력 제외
- [x] 모션 최소화 접근성 대응
...
## PHASE 15 — 곰 연어 잡기 스토리 애니메이션

- [x] 곰 이동 자세 프레임
- [x] 연어를 향해 손 뻗는 프레임
- [x] 양손으로 연어를 잡는 프레임
- [x] 연어를 들고 먹는 프레임
- [x] 오른쪽 출발·왼쪽 이동·오른쪽 복귀
- [x] 다중 이미지 단일 시간축 무한 반복
- [x] 기존 마우스 패럴랙스 연동
- [x] 모션 최소화 정지 화면
- [x] 단일 시간축 프레임 순서 검증
- [x] 이미지 배경 경계 제거
...
## PHASE 16 — 20프레임 자연스러운 동작 개선

- [x] 0.2초 간격 20프레임 구성
- [x] 총 4초 길이 무한 반복
- [x] 좌측 이동 걷기 자세 2종 교차
- [x] 숙이기·잡기·들기 중간 자세 추가
- [x] 연어를 입으로 올리고 먹는 중간 자세 추가
- [x] 연어를 든 채 오른쪽으로 퇴장
- [x] requestAnimationFrame 기준 프레임 동기화
- [x] 모션 최소화 접근성 유지
